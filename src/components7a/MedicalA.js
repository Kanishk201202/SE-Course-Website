...
export default function MedicalA() {
    ...
    {/*Navigation bar for navigating*/}
        ...
        <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link active" aria-current="page" to="/bookappointmenta">Book Appointment</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/medvisitsa">Medvisits</NavLink>
            </li>
        </ul>
