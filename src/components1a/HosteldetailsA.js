...
export default function HosteldetailsA() {
  return (
    <>
    {/*Navigation bar for navigating */}
        ...
        <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link active" aria-current="page" to="/hostelwardensa">Hostel Wardens</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/hostelstaffsa">Hostel Staffs</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/hostelinventorya">Hostel Inventory</NavLink>
            </li>
        </ul>
