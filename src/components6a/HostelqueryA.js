...
export default function HostelqueryA() {
  return (
    <>
    {/*Navigation bar for navigating*/}
        ...
        <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link active" aria-current="page" to="/ccdepartmenta">CC Department</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/eudepartmenta">EU Department</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/messquerya">Mess Query</NavLink>
            </li>
        </ul>
        <div classNameName="container my-3 w-75">
            {/*about mess*/}
        <h1>Hostel and Mess Query</h1>
