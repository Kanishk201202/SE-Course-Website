...
export default function Vacatingroom() {

        const [users, setUser] = useState({
            name:"",rollnumber:"",currentroom:"",programme:"",gender:"",email:"",contactnumber:"",fromdate:""
        });
        ...
        const PostData = async (e) => {
            ...
            const{ name, rollnumber, currentroom, programme, gender, email, contactnumber, fromdate } = users;
    
            const res = await fetch("/repon", {
                method: "POST",
                headers: {
