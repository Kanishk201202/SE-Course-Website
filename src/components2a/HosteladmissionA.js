...
export default function HosteladmissionA() {
  return (
    <>
    {/*Navigation bar for navigating */}
        ...
        <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link" to="/hostelfeesa">Hostel Fees</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/hostelinformationa">Hostel Information</NavLink>
            </li>
        </ul>
