...
export default function HostellogbookA() {
  return (
    <>
    ...
    {/*different tabs*/}
     <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link" to="/visitorslogbooka">Visitors Logbook</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/securitydetailsa">Security Details</NavLink>
            </li>
        </ul>
