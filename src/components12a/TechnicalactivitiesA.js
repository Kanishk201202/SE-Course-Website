...
export default function TechnicalactivitiesA() {
  return (
    <>
     {/*Navigation bar for navigating*/}
        ...
        <ul className="nav justify-content-center">
            <li className="nav-item">
                <NavLink className="nav-link active" aria-current="page" to="/technicalclubsa">Technical Clubs</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/technicaleventsa">Technical Events</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/workshopregistrationa">Workshop Registration</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/abouteventsa">About Events</NavLink>
            </li>
            <li className="nav-item">
                <NavLink className="nav-link" to="/feedbacka">Feedback</NavLink>
            </li>
        </ul>
